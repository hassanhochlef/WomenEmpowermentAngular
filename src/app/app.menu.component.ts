        ...
        this.model = [
            {
                ...
                items: [
                    {label: 'Front office', icon: 'pi pi-fw pi-home', routerLink: ['/']},
                    {label: 'Admin Dashboard', icon: 'pi pi-fw pi-home', routerLink: ['/admin/user']}
                ]
            },
            {separator: true},
            {
            ...
            {separator: true},
            {
                ...
                items: [
                    ...
                    {label: 'CrudEvent', icon: 'pi pi-fw pi-pencil', routerLink: ['/pages/event']},
                    {label: 'donationCrud', icon: 'pi pi-fw pi-pencil', routerLink: ['/pages/donation']},
